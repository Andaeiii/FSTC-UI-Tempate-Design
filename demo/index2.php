...
Ricochet seeks to create a forum for socially aware knowledge seeking change driven individuals to be engaged with hard-hitting material concerning society, human development, profession, and ultimately our evolution as specie, a people, a demographic, a culture, and a time....."
               ...
               <div id="t4" class="content" style="display: block; opacity: 1;">
                    ...
                    <div id="rteamids" class="rteamids">   
                        ...
                        <a id="tb3" class="rtbox" href="javascript:;" onclick="chgTeam(3, this);" style="opacity: 0.4;">
                            <span id="rfname" class="fname">Kelechi</span>
                            <span id="rsname" class="sname">Deca</span>
                        </a> 
                         
                        <a id="tb4" class="rtbox" href="javascript:;" onclick="chgTeam(4, this);" style="opacity: 0.4;">
...
He is multilingual,and married with four children.
                            ...
                            <span class="msg scroller" id="tm4">
...
He is very passionate about inspiring the emergence of a new generation of leaders. King is the lead partner at GreyhamBounds Solicitors &amp; Attorneys.
                    ...
                    <div class="xmails" id="xmails">
                    	<span>email</span>
                         <a id="m1" class="smail" href="mailto:ujuaku@tedxjabi.com" class="email" target="_blank">ujuaku@tedxjabi.com</a>  
                         <a id="m2" class="smail" href="mailto:ninah@tedxjabi.com" class="email" target="_blank">ninah@tedxjabi.com</a>  
                         <a id="m3" class="smail" href="mailto:kelechi@tedxjabi.com" class="email" target="_blank">kelechi@tedxjabi.com</a>
                         <a id="m4" class="smail" href="mailto:ilemona@tedxjabi.com" class="email" target="_blank">ilemona@tedxjabi.com</a>  
                    </div>
                    <div class="clr" id="clr"></div>
                    ...
                    <div id="teamdiv" class="thmbs">
                        ...
                        <a id="w3" href="javascript:;" onclick="chgTeam(3, this);"><img src="team/s3.jpg" width="87" height="87"></a>
                        <a id="w4" href="javascript:;" onclick="chgTeam(4, this);"><img src="team/s4.jpg" width="87" height="87"></a>
                        <div class="clr" id="clr"></div>
                    </div>
